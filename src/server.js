export default[
    ...
    type:'1,የጀማሪዎች አሰልጣኝ', 
    nameOfUstaz:'አቢ ኢስሃቅ',
    definition:'ስለ ኪታቡ ለማወቅ ያህል...  \nየ መጽሃፉ ስም፡\nእምነትህን ከ ቁራአን እና ጠንካራ ከሆነ ከ ነቢዩ(ሰ.አ.ወ) ንግግር (ሃዲስ) ያዝ።\n አዘጋጅ፡\n በ መካ አል ሙከረማህ ኡስታዝ እንዲሁም ታላቅ ኣሊም በሆኑት ሙሃመድ ጀሚል ዚኑ የተዘጋጀ ሲሆን የ ተወለዱትም በ 1343 (አመተ ሂጅራ) ሃላብ በሚባል ከተማ ሲሆን አሏህ ይዘንላቸውና ወደ አኺራ የሀዱት በ 1431 (አመተ ሂጅራ) ነው።\n የ መጽሃፉ አጻጻፍ ሁነታ፡\n በ ጥያቂና መልስ መልክ የቀረበ ሲሆን እጥር ምጥን ያለ መጽሃፍ ነው።',
    kitaName:'ኹዝ-ዐቂደተክ',
